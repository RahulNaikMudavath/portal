    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-xs">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-black text-white">Add New Engineer</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500/50"
                  required
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  value={form.password}
                  onChange={handleChange}
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-3.5 pr-10 py-2.5 text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500/50"
                  required
                />
                <button
                  type="button"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-white focus:outline-none focus:border-indigo-500/50"
                >
